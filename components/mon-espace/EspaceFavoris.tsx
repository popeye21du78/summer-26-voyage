    ...
    <section className="px-5 py-6">
      ...
      {favorites.length === 0 ? (
        <div className="rounded-xl border border-dashed border-white/8 py-8 text-center">
          <Heart className="mx-auto h-8 w-8 text-[#E07856]/20" />
        ...
        <div className="space-y-2">
          {favorites.map((fav) => {
            ...
            return (
              ...
              >
                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[#E07856]/15">
                  <Icon className="h-4 w-4 text-[#E07856]" />
                </div>
